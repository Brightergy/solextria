defmodule Solextria.Utils do
  ...
  def build_http_opts(opts),
    do: Keyword.merge(Application.get_env(:solextria, :http_opts) || [], opts)
  ...
  def erlang_time_to_iso8601({{yr, mth, day}, {hr, mm, ss}}) do
    List.flatten(
      :io_lib.format("~4..0w-~2..0w-~2..0wT~2..0w:~2..0w:~2..0wZ", [yr, mth, day, hr, mm, ss])
    )
  end
